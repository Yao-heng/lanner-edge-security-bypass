graph TD
    ...
    %% Hardware Layers
    subgraph subg_Host [Host Compute Subsystem]
    ...
    subgraph subg_Lanner [Lanner Proprietary Network I/O]
        NIC[Network Security Card<br/>Hardware Bypass Relay]:::hardware
    end

    %% Management & Security Control Tiers
    subgraph subg_OOB [Out-of-Band Management & Automation Control]
